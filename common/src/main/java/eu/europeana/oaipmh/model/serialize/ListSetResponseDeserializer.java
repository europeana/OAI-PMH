 ...
 */
public class ListSetResponseDeserializer extends StdDeserializer<ListSetsResponse> {
    ...
    public ListSetResponseDeserializer() {
        this(null);
    }

    public ListSetResponseDeserializer(Class<?> vc) {
        super(vc);
    }
